...
namespace Hexfall.Grid
{
    public class ManualGrid
    {
        ...
        {
            hexagonGrid[0, 0] = CreateNewHexagon(0, 0, HexagonType.Blue, hexagonProperties.HexagonPrefab);
            hexagonGrid[1, 0] = CreateNewHexagon(1, 0, HexagonType.Cyan, hexagonProperties.HexagonPrefab);
            hexagonGrid[2, 0] = CreateNewHexagon(2, 0, HexagonType.Red, hexagonProperties.HexagonPrefab);
            hexagonGrid[3, 0] = CreateNewHexagon(3, 0, HexagonType.Purple, hexagonProperties.HexagonPrefab);
            hexagonGrid[4, 0] = CreateNewHexagon(4, 0, HexagonType.Yellow, hexagonProperties.HexagonPrefab);
            hexagonGrid[5, 0] = CreateNewHexagon(5, 0, HexagonType.Purple, hexagonProperties.HexagonPrefab);
            ...
            hexagonGrid[4, 1] = CreateNewHexagon(4, 1, HexagonType.Red, hexagonProperties.HexagonPrefab);
            hexagonGrid[5, 1] = CreateNewHexagon(5, 1, HexagonType.Yellow, hexagonProperties.HexagonPrefab);
            ...
            hexagonGrid[4, 2] = CreateNewHexagon(4, 2, HexagonType.Red, hexagonProperties.HexagonPrefab);
            hexagonGrid[5, 2] = CreateNewHexagon(5, 2, HexagonType.Yellow, hexagonProperties.HexagonPrefab);
            hexagonGrid[6, 2] = CreateNewHexagon(6, 2, HexagonType.Cyan, hexagonProperties.HexagonPrefab);
            hexagonGrid[7, 2] = CreateNewHexagon(7, 2, HexagonType.Blue, hexagonProperties.HexagonPrefab);

            hexagonGrid[0, 3] = CreateNewHexagon(0, 3, HexagonType.Blue, hexagonProperties.HexagonPrefab);
            hexagonGrid[1, 3] = CreateNewHexagon(1, 3, HexagonType.Purple, hexagonProperties.HexagonPrefab);
            hexagonGrid[2, 3] = CreateNewHexagon(2, 3, HexagonType.Red, hexagonProperties.HexagonPrefab);
            hexagonGrid[3, 3] = CreateNewHexagon(3, 3, HexagonType.Purple, hexagonProperties.HexagonPrefab);
            hexagonGrid[4, 3] = CreateNewHexagon(4, 3, HexagonType.Yellow, hexagonProperties.HexagonPrefab);
            hexagonGrid[5, 3] = CreateNewHexagon(5, 3, HexagonType.Purple, hexagonProperties.HexagonPrefab);
            hexagonGrid[6, 3] = CreateNewHexagon(6, 3, HexagonType.Purple, hexagonProperties.HexagonPrefab);
            hexagonGrid[7, 3] = CreateNewHexagon(7, 3, HexagonType.Cyan, hexagonProperties.HexagonPrefab);

            hexagonGrid[0, 4] = CreateNewHexagon(0, 4, HexagonType.Purple, hexagonProperties.HexagonPrefab);
            hexagonGrid[1, 4] = CreateNewHexagon(1, 4, HexagonType.Yellow, hexagonProperties.HexagonPrefab);
            hexagonGrid[2, 4] = CreateNewHexagon(2, 4, HexagonType.Red, hexagonProperties.HexagonPrefab);
            hexagonGrid[3, 4] = CreateNewHexagon(3, 4, HexagonType.Cyan, hexagonProperties.HexagonPrefab);
            hexagonGrid[4, 4] = CreateNewHexagon(4, 4, HexagonType.Red, hexagonProperties.HexagonPrefab);
            hexagonGrid[5, 4] = CreateNewHexagon(5, 4, HexagonType.Yellow, hexagonProperties.HexagonPrefab);
            hexagonGrid[6, 4] = CreateNewHexagon(6, 4, HexagonType.Purple, hexagonProperties.HexagonPrefab);
            hexagonGrid[7, 4] = CreateNewHexagon(7, 4, HexagonType.Yellow, hexagonProperties.HexagonPrefab);

            hexagonGrid[0, 5] = CreateNewHexagon(0, 5, HexagonType.Yellow, hexagonProperties.HexagonPrefab);
            hexagonGrid[1, 5] = CreateNewHexagon(1, 5, HexagonType.Purple, hexagonProperties.HexagonPrefab);
            hexagonGrid[2, 5] = CreateNewHexagon(2, 5, HexagonType.Green, hexagonProperties.HexagonPrefab);
            hexagonGrid[3, 5] = CreateNewHexagon(3, 5, HexagonType.Blue, hexagonProperties.HexagonPrefab);
        ...
        private Hexagon CreateNewHexagon(int width, int height, HexagonType hexagonType, Hexagon hexagonPrefab)
        {
            ...
            var hexagon = Object.Instantiate(hexagonProperties.HexagonPrefab, hexPosition, Quaternion.identity);
